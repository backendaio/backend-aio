...
function getforminfo(site){
	...
	var nike_info = '0,0,0,0,1754,630,0;',
		best_buy_info = '0,0,0,0,1487,231,0;0,-1,0,1,1627,1627,0;', 
        ...
        gamestop_info = ',0,0,0,-1,113,0;0,-1,0,1,2015,3433,0;0,-1,0,1,2021,3317,0;0,-1,0,1,2034,3002,0;0,2,0,1,2352,3433,0;0,2,0,1,2358,3317,0;0,2,0,1,2353,2984,0;1,2,0,1,2716,3002,0;0,2,0,1,2371,3002,0;0,-1,0,1,2891,2984,0;0,-1,0,0,1805,4204,0;0,-1,0,0,1009,3946,0;1,0,0,1,3256,3002,0;0,-1,0,0,2893,-1,0;0,-1,0,1,2911,3002,0;0,-1,0,1,2892,3433,0;0,-1,0,1,2898,3317,0;0,-1,0,0,-1,2424,0;',
        ...
        pacsun_info = '0,0,0,0,113,113,0;0,-1,0,0,750,1038,0;0,0,0,0,1182,360,0;0,0,0,0,-1,1134,0;',
    ...
    function gen_mact_string(){
        ...
        if(Math.random() > 0.5){
            ...
            for(var a = 0; a < amount; a++){
                ...
                c = bmak_me_cnt + ',' + t[random(0,3)] + ',' + k + ',' + n + ',' + o;
                c = c + ',' + r;
...
function get_nav_perm(site){
    ...
    var nike_nav_perm = '10321144241322243122', 
        fed_ex_nav_perm = '', 
        best_buy_nav_perm = '00321144241322243122',
        home_depot_nav_perm = '22322244242322243222',
        ...
        best_buy_ca_nav_perm = '11321144241322243122',
        ...
        jd_nav_perm = '22322244242322243222',
...
async function generate_sensor_data(site,url,cookie, challenge_ = false, aj_indx = null) {
