...
var devices = require('./all_devices.json');
//var device = require('./devices/device2.json');
...
var bmak_cs = '0a46G5m17Vrp4o4c',
    ...
    bmak_fpcf_rVal = Math.floor(1e3 * Math.random()).toString(),
    //bmak.fpcf.rCFP
    ...
    bmak_start_ts = Date.now() + random(2536, 3625),
    bmak_y1 = 2016,
...
function getforminfo(site){
	...
	var nike_info = '0,0,0,0,1754,630,0;',
        ...
        rebook_info = '',
        yzy_info = '',
        zalando_info = '0,0,0,0,-1,113,0;0,-1,0,0,1066,-1,0;',
        ...
        gap_info = '',
        adidas_info = '',
        kohl_info = '0,0,0,0,630,630,0;0,0,0,0,1000,1632,1;0,-1,0,0,3406,891,0;0,-1,0,0,3405,891,0;';
...
function gd() {
    ...
    var n = window_screen ? window_screen_availWidth : -1,
...
function get_nav_perm(site){
    ...
    var nike_nav_perm = '10321144241322243122', 
        ...
        uniqlo_nav_perm = '20321144241322243122',
        ...
        kohl_nav_perm = '10321144241322243122';
...
function scale(){
    ...
    Math.random() > 0.5 ? window_addEventListener = true : window_addEventListener = false; 
    Math.random() > 0.5 ? window_XMLHttpRequest = true : window_XMLHttpRequest = false;
    Math.random() > 0.5 ? window_XDomainRequest = true : window_XDomainRequest = false;
    Math.random() > 0.5 ? window_emit = true : window_emit = false;
    Math.random() > 0.5 ? window_DeviceOrientationEvent = true : window_DeviceOrientationEvent = false;
    Math.random() > 0.5 ? window_DeviceMotionEvent = true : window_DeviceMotionEvent = false;
    Math.random() > 0.5 ? window_TouchEvent = true : window_TouchEvent = false;
    Math.random() > 0.5 ? window_spawn = true : window_spawn = false;
    Math.random() > 0.5 ? Function_prototype_bind = true : Function_prototype_bind = false;
    Math.random() > 0.5 ? window_Buffer = true : window_Buffer = false;
    Math.random() > 0.5 ? window_PointerEvent = true : false;
    Math.random() > 0.5 ? window_ActiveXObject = true : window_ActiveXObject = false;
    Math.random() > 0.5 ? document_documentMode = true : document_documentMode = false;
    Math.random() > 0.5 ? window_chrome_window_chrome_webstore = true : window_chrome_window_chrome_webstore = false;
    Math.random() > 0.5 ? window_opera = true : window_opera = false;
    Math.random() > 0.5 ? InstallTrigger = true : InstallTrigger = false;
    Math.random() > 0.5 ? window_HTMLElement = true : window_HTMLElement = false;
    Math.random() > 0.5 ? window_webkitRTCPeerConnection = true : window_webkitRTCPeerConnection = false;
    //Math.random() > 0.5 ? window_mozInnerScreenY = true : window_mozInnerScreenY = false;
    Math.random() > 0.5 ? navigator_vibrate = true : navigator_vibrate = false;
    Math.random() > 0.5 ? Array_prototype_forEach = true : Array_prototype_forEach = false;
    Math.random() > 0.5 ? FileReader = true : FileReader = false;
    Math.random() > 0.5 ? window_DeviceMotionEvent = true : window_DeviceMotionEvent = false;
    Math.random() > 0.5 ? window_$cdc_asdjflasutopfhvcZLmcfl_ = true : window_$cdc_asdjflasutopfhvcZLmcfl_ = false;
    Math.random() > 0.5 ? document_$cdc_asdjflasutopfhvcZLmcfl_ = true : document_$cdc_asdjflasutopfhvcZLmcfl_ = false;
    Math.random() > 0.5 ? window_XPathResult = true : window_XPathResult = false;
    Math.random() > 0.5 ? window_indexedDB = true : window_indexedDB = false;
    Math.random() > 0.5 ? webrtcKey = true : webrtcKey = false;
    Math.random() > 0.5 ? window_localStorage = true : window_localStorage = false;
    Math.random() > 0.5 ? window_sessionStorage = true : window_sessionStorage = false;
    Math.random() > 0.5 ? bmak_runFonts = true : bmak_runFonts = false;
    Math.random() > 0.5 ? bmak_altFonts = true : bmak_altFonts = false;
    screen_colorDepth = random(8,30);
    screen_pixelDepth = screen_colorDepth;
    Math.random() > 0.5 ? navigator_doNotTrack = 1 : navigator_doNotTrack = null;
    Math.random() > 0.5 ? navigator_plugins = 3 : navigator_plugins = 0;

};

function choose_a_random_device(device_number){

    var device = devices[device_number];

    //console.log(device);
    window_screen_availWidth = device['device']['window_screen_availWidth']; 
    window_screen_availHeight = device['device']['window_screen_availHeight'];
    window_screen_height = device['device']['window_screen_height'];
    window_innerHeight = device['device']['window_innerHeight'];
    window_innerWidth = device['device']['window_innerWidth'];
    window_outerWidth = device['device']['window_outerWidth'];
    bmak_fpcf_rCFP = parseInt(device['device']['bmak_fpcf_rCFP']);
    canvas_1 = device['device']['canvas_1'];
    canvas_2 = device['device']['canvas_2'];
    navigator_plugins_length = device['device']['navigator_plugins_length'];

    //console.log(bmak_fpcf_rCFP);
};

//choose_a_random_device(0);

function csh(){

    var speech_array = [{voiceURI: "Alex", name: "Alex", lang: "en-US", localService: true, default: true}, {voiceURI: "Alice", name: "Alice", lang: "it-IT", localService: true, default: false}, {voiceURI: "Alva", name: "Alva", lang: "sv-SE", localService: true, default: false}, {voiceURI: "Amelie", name: "Amelie", lang: "fr-CA", localService: true, default: false}, {voiceURI: "Anna", name: "Anna", lang: "de-DE", localService: true, default: false}, {voiceURI: "Carmit", name: "Carmit", lang: "he-IL", localService: true, default: false}, {voiceURI: "Damayanti", name: "Damayanti", lang: "id-ID", localService: true, default: false}, {voiceURI: "Daniel", name: "Daniel", lang: "en-GB", localService: true, default: false}, {voiceURI: "Diego", name: "Diego", lang: "es-AR", localService: true, default: false},{voiceURI: "Ellen", name: "Ellen", lang: "nl-BE", localService: true, default: false}, {voiceURI: "Fiona", name: "Fiona", lang: "en", localService: true, default: false},{voiceURI: "Fred", name: "Fred", lang: "en-US", localService: true, default: false},{voiceURI: "Ioana", name: "Ioana", lang: "ro-RO", localService: true, default: false},
    {voiceURI: "Joana", name: "Joana", lang: "pt-PT", localService: true, default: false}, {voiceURI: "Jorge", name: "Jorge", lang: "es-ES", localService: true, default: false}, {voiceURI: "Juan", name: "Juan", lang: "es-MX", localService: true, default: false}, {voiceURI: "Kanya", name: "Kanya", lang: "th-TH", localService: true, default: false}, {voiceURI: "Karen", name: "Karen", lang: "en-AU", localService: true, default: false},{voiceURI: "Kyoko", name: "Kyoko", lang: "ja-JP", localService: true, default: false},{voiceURI: "Laura", name: "Laura", lang: "sk-SK", localService: true, default: false},{voiceURI: "Lekha", name: "Lekha", lang: "hi-IN", localService: true, default: false},{voiceURI: "Luca", name: "Luca", lang: "it-IT", localService: true, default: false},{voiceURI: "Luciana", name: "Luciana", lang: "pt-BR", localService: true, default: false},{voiceURI: "Maged", name: "Maged", lang: "ar-SA", localService: true, default: false},{voiceURI: "Mariska", name: "Mariska", lang: "hu-HU", localService: true, default: false},{voiceURI: "Mei-Jia", name: "Mei-Jia", lang: "zh-TW", localService: true, default: false},{voiceURI: "Melina", name: "Melina", lang: "el-GR", localService: true, default: false},
    {voiceURI: "Milena", name: "Milena", lang: "ru-RU", localService: true, default: false}, {voiceURI: "Moira", name: "Moira", lang: "en-IE", localService: true, default: false}, {voiceURI: "Monica", name: "Monica", lang: "es-ES", localService: true, default: false}, {voiceURI: "Nora", name: "Nora", lang: "nb-NO", localService: true, default: false}, {voiceURI: "Paulina", name: "Paulina", lang: "es-MX", localService: true, default: false}, {voiceURI: "Rishi", name: "Rishi", lang: "en-IN", localService: true, default: false}, {voiceURI: "Samantha", name: "Samantha", lang: "en-US", localService: true, default: false}, {voiceURI: "Sara", name: "Sara", lang: "da-DK", localService: true, default: false}, {voiceURI: "Satu", name: "Satu", lang: "fi-FI", localService: true, default: false}, {voiceURI: "Sin-ji", name: "Sin-ji", lang: "zh-HK", localService: true, default: false}, {voiceURI: "Tessa", name: "Tessa", lang: "en-ZA", localService: true, default: false}, {voiceURI: "Thomas", name: "Thomas", lang: "fr-FR", localService: true, default: false}, {voiceURI: "Ting-Ting", name: "Ting-Ting", lang: "zh-CN", localService: true, default: false}, 
    {voiceURI: "Veena", name: "Veena", lang: "en-IN", localService: true, default: false}, {voiceURI: "Victoria", name: "Victoria", lang: "en-US", localService: true, default: false}, {voiceURI: "Xander", name: "Xander", lang: "nl-NL", localService: true, default: false}, {voiceURI: "Yelda", name: "Yelda", lang: "tr-TR", localService: true, default: false}, {voiceURI: "Yuna", name: "Yuna", lang: "ko-KR", localService: true, default: false}, {voiceURI: "Yuri", name: "Yuri", lang: "ru-RU", localService: true, default: false}, {voiceURI: "Zosia", name: "Zosia", lang: "pl-PL", localService: true, default: false}, {voiceURI: "Zuzana", name: "Zuzana", lang: "cs-CZ", localService: true, default: false}, {voiceURI: "Google Deutsch", name: "Google Deutsch", lang: "de-DE", localService: false, default: false}, {voiceURI: "Google US English", name: "Google US English", lang: "en-US", localService: false, default: false}, {voiceURI: "Google UK English Female", name: "Google UK English Female", lang: "en-GB", localService: false, default: false}, {voiceURI: "Google UK English Male", name: "Google UK English Male", lang: "en-GB", localService: false, default: false}, {voiceURI: "Google español", name: "Google español", lang: "es-ES", localService: false, default: false}, 
    {voiceURI: "Google español de Estados Unidos", name: "Google español de Estados Unidos", lang: "es-US", localService: false, default: false } , {voiceURI: "Google français", name: "Google français", lang: "fr-FR", localService: false, default: false}, {voiceURI: "Google हिन्दी", name: "Google हिन्दी", lang: "hi-IN", localService: false, default: false},  {voiceURI: "Google Bahasa Indonesia", name: "Google Bahasa Indonesia", lang: "id-ID", localService: false, default: false}, {voiceURI: "Google italiano", name: "Google italiano", lang: "it-IT", localService: false, default: false}, {voiceURI: "Google 日本語", name: "Google 日本語", lang: "ja-JP", localService: false, default: false}, {voiceURI: "Google 한국의", name: "Google 한국의", lang: "ko-KR", localService: false, default: false}, {voiceURI: "Google Nederlands", name: "Google Nederlands", lang: "nl-NL", localService: false, default: false}, {voiceURI: "Google polski", name: "Google polski", lang: "pl-PL", localService: false, default: false}, {voiceURI: "Google português do Brasil", name: "Google português do Brasil", lang: "pt-BR", localService: false, default: false}, {voiceURI: "Google русский", name: "Google русский", lang: "ru-RU", localService: false, default: false},  {voiceURI: "Google 普通话（中国大陆）", name: "Google 普通话（中国大陆）", lang: "zh-CN", localService: false, default: false}, {voiceURI: "Google 粤語（香港）", name: "Google 粤語（香港）", lang: "zh-HK", localService: false, default: false}, 
    {voiceURI: "Google 國語（臺灣）", name: "Google 國語（臺灣）", lang: "zh-TW", localService: false, default: false}];

    //if(speech_array.length > 0){

    //    for (var a = '', e = 0; e < speech_array.length; e++){

    //        a += speech_array[e].voiceURI + '_' + speech_array[e].lang;
    //    };

    //     var bmak_ssh = ats(mn_s(a));
    //     console.log(bmak_ssh);
    //};

    var random_number_ssh = random(0, speech_array.length - 1);
    //console.log(random_number_ssh);

    for (var b = 0; b < random_number_ssh; b++){

        speech_array.splice(random(0, speech_array.length - 1), 1);
    };
    ...
    Math.random() > 0.8 ? bmak_ssh = '0' : bmak_ssh = bmak_ssh;

    return bmak_ssh;
};

function generate_bmak_fmh(){

    var bmak_fmh_array = ['87838b6b28b2e952ff9e4e3f1f00f6c6146fa8090ee5d0541c06ecdc180622da', '','87838b6b28b2e952ff9e4e3f1f00f6c6146fa8090ee5d0541c06ecdc180622da', '87838b6b28b2e952ff9e4e3f1f00f6c6146fa8090ee5d0541c06ecdc180622da','94bd8db41ea820c05f4f90b67251ea8250177bedfa65e9ef1a4b6b16e93995e6', '94bd8db41ea820c05f4f90b67251ea8250177bedfa65e9ef1a4b6b16e93995e6', '082671395fd8efe3a9d780b266c2a8a8cb2db9a408d68ba6c926d5608ab9a84d', '94bd8db41ea820c05f4f90b67251ea8250177bedfa65e9ef1a4b6b16e93995e6', 'e7fa8e5f9331739c57ebdd0dd49e398c3662b0b364b74c7c64bf301e2c66dd3a', '94bd8db41ea820c05f4f90b67251ea8250177bedfa65e9ef1a4b6b16e93995e6,1,0,Google Inc.,Google SwiftShader,3c84d65d49fb3b8d03ed2f26bf53630900f726ac7aa573f0a715315b02e21805,27','94bd8db41ea820c05f4f90b67251ea8250177bedfa65e9ef1a4b6b16e93995e6'];
    bmak_fmh_array = bmak_fmh_array[random(0, bmak_fmh_array.length - 1)];

    return bmak_fmh_array;
};

async function generate_token(){

    var bmak_wv = 'Google Inc.';

    var bmak_fmz = 1;
    var bmak_wr = 'Google SwiftShader';
    var bmak_weh = '3c84d65d49fb3b8d03ed2f26bf53630900f726ac7aa573f0a715315b02e21805'; 
    var bmak_ssh = await csh();
    var bmak_wl = random(0, 36);
    var bmak_fmh = await generate_bmak_fmh();

    var w = bmak_fmh + ',' + bmak_fmz + ',' + bmak_ssh + ',' + bmak_wv + ',' + bmak_wr + ',' + bmak_weh + ',' + bmak_wl;

    return w;
};

async function generate_sensor_data(site,url,cookie, challenge_ = false, aj_indx = null, agent = null, device_number = null) {
   ...
   // canvas_1 = 1359025438; 
    ...
    if(device_number){
        ...
        await choose_a_random_device(device_number);
    };
   ...
   if(!mact && !bmak_kact && bmak_vcact){
    ...
    //var w = await random_w();
    //var w = await generate_token();
...
function random_w(){
    ...
    var w_array = ['87838b6b28b2e952ff9e4e3f1f00f6c6146fa8090ee5d0541c06ecdc180622da,1,0,Google Inc.,Google SwiftShader,3c84d65d49fb3b8d03ed2f26bf53630900f726ac7aa573f0a715315b02e21805,27','','87838b6b28b2e952ff9e4e3f1f00f6c6146fa8090ee5d0541c06ecdc180622da,1,929744a91e4d3839e9371de5132eb9b075f0a6bf503d7b0da4a50cbe32922620,ATI Technologies Inc.,AMD Radeon Pro 5500M OpenGL Engine,ec2c8e52711ccf8763d8e097e5117f39f5707ebb56230f08421fbbc565148594,30','87838b6b28b2e952ff9e4e3f1f00f6c6146fa8090ee5d0541c06ecdc180622da,1,0,Google Inc.,Google SwiftShader,3c84d65d49fb3b8d03ed2f26bf53630900f726ac7aa573f0a715315b02e21805,27','87838b6b28b2e952ff9e4e3f1f00f6c6146fa8090ee5d0541c06ecdc180622da,1,929744a91e4d3839e9371de5132eb9b075f0a6bf503d7b0da4a50cbe32922620,,,,0','94bd8db41ea820c05f4f90b67251ea8250177bedfa65e9ef1a4b6b16e93995e6,1,929744a91e4d3839e9371de5132eb9b075f0a6bf503d7b0da4a50cbe32922620,ATI Technologies Inc.,AMD Radeon Pro 5500M OpenGL Engine,f437e95c71eb8e0326eb22e9cba9c05b86068086180a4ca09b3bcd32320a1928,31','94bd8db41ea820c05f4f90b67251ea8250177bedfa65e9ef1a4b6b16e93995e6,1,929744a91e4d3839e9371de5132eb9b075f0a6bf503d7b0da4a50cbe32922620,,,,0','082671395fd8efe3a9d780b266c2a8a8cb2db9a408d68ba6c926d5608ab9a84d,1,929744a91e4d3839e9371de5132eb9b075f0a6bf503d7b0da4a50cbe32922620,,,,0','87838b6b28b2e952ff9e4e3f1f00f6c6146fa8090ee5d0541c06ecdc180622da,1,929744a91e4d3839e9371de5132eb9b075f0a6bf503d7b0da4a50cbe32922620,,,,0','94bd8db41ea820c05f4f90b67251ea8250177bedfa65e9ef1a4b6b16e93995e6,1,929744a91e4d3839e9371de5132eb9b075f0a6bf503d7b0da4a50cbe32922620,,,,0','94bd8db41ea820c05f4f90b67251ea8250177bedfa65e9ef1a4b6b16e93995e6,1,0d65734a64c01ce05475c3345af06aef5246ddb8f0161ec4776e6f9c160dfd9b,Google Inc.,Google SwiftShader,3c84d65d49fb3b8d03ed2f26bf53630900f726ac7aa573f0a715315b02e21805,27','94bd8db41ea820c05f4f90b67251ea8250177bedfa65e9ef1a4b6b16e93995e6,1,929744a91e4d3839e9371de5132eb9b075f0a6bf503d7b0da4a50cbe32922620,,,,0','87838b6b28b2e952ff9e4e3f1f00f6c6146fa8090ee5d0541c06ecdc180622da,1,0,,,,','87838b6b28b2e952ff9e4e3f1f00f6c6146fa8090ee5d0541c06ecdc180622da,1,0d65734a64c01ce05475c3345af06aef5246ddb8f0161ec4776e6f9c160dfd9b,,,,0','94bd8db41ea820c05f4f90b67251ea8250177bedfa65e9ef1a4b6b16e93995e6,1,0,Google Inc.,Google SwiftShader,3c84d65d49fb3b8d03ed2f26bf53630900f726ac7aa573f0a715315b02e21805,27','94bd8db41ea820c05f4f90b67251ea8250177bedfa65e9ef1a4b6b16e93995e6,1,0d65734a64c01ce05475c3345af06aef5246ddb8f0161ec4776e6f9c160dfd9b,,,,0','87838b6b28b2e952ff9e4e3f1f00f6c6146fa8090ee5d0541c06ecdc180622da,1,0d65734a64c01ce05475c3345af06aef5246ddb8f0161ec4776e6f9c160dfd9b,,,,0','082671395fd8efe3a9d780b266c2a8a8cb2db9a408d68ba6c926d5608ab9a84d,1,0d65734a64c01ce05475c3345af06aef5246ddb8f0161ec4776e6f9c160dfd9b,,,,0','87838b6b28b2e952ff9e4e3f1f00f6c6146fa8090ee5d0541c06ecdc180622da,1,0,,,,0',',,0d65734a64c01ce05475c3345af06aef5246ddb8f0161ec4776e6f9c160dfd9b,,,,0','94bd8db41ea820c05f4f90b67251ea8250177bedfa65e9ef1a4b6b16e93995e6,1,0d65734a64c01ce05475c3345af06aef5246ddb8f0161ec4776e6f9c160dfd9b,Google Inc.,Google SwiftShader,3c84d65d49fb3b8d03ed2f26bf53630900f726ac7aa573f0a715315b02e21805,27','87838b6b28b2e952ff9e4e3f1f00f6c6146fa8090ee5d0541c06ecdc180622da,2,0d65734a64c01ce05475c3345af06aef5246ddb8f0161ec4776e6f9c160dfd9b,Intel Inc.,Intel(R) Iris(TM) Plus Graphics OpenGL Engine (1x6x8 (fused) LP,f437e95c71eb8e0326eb22e9cba9c05b86068086180a4ca09b3bcd32320a1928,31','e7fa8e5f9331739c57ebdd0dd49e398c3662b0b364b74c7c64bf301e2c66dd3a,1.25,a712c19fde04cde08d21754c81e951066896404f0eac6cbfd5255e434d879986,Google Inc.,ANGLE (NVIDIA GeForce GTX 1080 with Max-Q Design Direct3D11 vs_5_0 ps_5_0),95f5b71fe531f867faa814bdd4050dd8057206d53ecec1163523560525884870,33','']; 
    var w = w_array[random(0,w_array.length - 1)];
    return w;
};

function random_nav_perm(){

    var nav_perm_array = ['10321144241322243122','20321144241322243122','00321144241322243122','11321144241322243122','22322244242322243222'];
    var nav_perm = nav_perm_array[random(0, nav_perm_array.length - 1)];
    return nav_perm;
};

//choose_a_random_device();
//gen_sensor();
//console.log(bmak_ta);
